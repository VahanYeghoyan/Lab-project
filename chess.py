...
bp = Piece('b', 'p', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\bp.png")
wp = Piece('w', 'p', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\wp.png")
bk = Piece('b', 'k', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\bQ.png")
wk = Piece('w', 'k', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\wQ.png")
br = Piece('b', 'r', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\bR.png")
wr = Piece('w', 'r', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\wR.png")
bb = Piece('b', 'b', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\bB.png")
wb = Piece('w', 'b', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\wB.png")
bq = Piece('b', 'q', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\bK.png")
wq = Piece('w', 'q', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\wK.png")
bkn = Piece('b', 'kn', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\bN.png")
wkn = Piece('w', 'kn', "C:\\Users\\DELL\\OneDrive\\Desktop\\drive-download-20221116T195423Z-001\\wN.png")
...
def check_team(moves, index):
    ...
    if moves%2 == 0 and moves == 0 :
        board[row][col].team == 'w'
        return True
    else:
        board[row][col].team == 'b'
        return True
    ...
    if moves % 2 == 0 :
        if board[row][col].team == color:
            return True
    else:
        if board[row][col].team == color_2:
            return True
...
def startgame1():
    ...
    change_color('b')
    starting_order= {(0, 7): pygame.image.load(br.image), (1, 7): pygame.image.load(bkn.image),
                  (2, 7): pygame.image.load(bb.image), (3, 7): pygame.image.load(bk.image),
                  (4, 7): pygame.image.load(bq.image), (5, 7): pygame.image.load(bb.image),
                  (6, 7): pygame.image.load(bkn.image), (7, 7): pygame.image.load(br.image),
                  (0, 6): pygame.image.load(bp.image), (1, 6): pygame.image.load(bp.image),
                  (2, 6): pygame.image.load(bp.image), (3, 6): pygame.image.load(bp.image),
                  (4, 6): pygame.image.load(bp.image), (5, 6): pygame.image.load(bp.image),
                  (6, 6): pygame.image.load(bp.image), (7, 6): pygame.image.load(bp.image),
                  ...
                  (0, 1): pygame.image.load(wp.image), (1, 1): pygame.image.load(wp.image),
                  (2, 1): pygame.image.load(wp.image), (3, 1): pygame.image.load(wp.image),
                  (4, 1): pygame.image.load(wp.image), (5, 1): pygame.image.load(wp.image),
                  (6, 1): pygame.image.load(wp.image), (7, 1): pygame.image.load(wp.image),
                  (0, 0): pygame.image.load(wr.image), (1, 0): pygame.image.load(wkn.image),
                  (2, 0): pygame.image.load(wb.image), (3, 0): pygame.image.load(wk.image),
                  (4, 0): pygame.image.load(wq.image), (5, 0): pygame.image.load(wb.image),
                  (6, 0): pygame.image.load(wkn.image), (7, 0): pygame.image.load(wr.image), 
                  }
...
surface = create_example_window('Chess', (800, 800))
...
menu.add.button('CHOOSE COLOR')
menu.add.button('white',startgame2)
menu.add.button('black',startgame1)
